...
public final class StdoutTerminal: Terminal, @unchecked Sendable {
    ...
    public func onResize(_ handler: @escaping @Sendable (Int, Int) -> Void) -> () -> Void {
        let id = UUID()
...
public final class RawStdin: @unchecked Sendable {
    private var savedTermios: termios
    private let fd: Int32
    private let dispatchSource: DispatchSourceRead

    public init(handler: @escaping @Sendable (Data) -> Void) throws {
...
public enum RawStdinError: Error {
    case cannotGetAttr
    case cannotSetAttr
}
#endif
